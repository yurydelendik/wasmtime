...
impl crate::compilation::Compiler for Cranelift {
    ...
    > {
        ...
        let mut stack_slots: PrimaryMap<DefinedFuncIndex, _> =
            PrimaryMap::with_capacity(function_body_inputs.len());
        ...
        function_body_inputs
            ...
            .into_iter()
            .for_each(|(function, relocs, address_transform, ranges, sss)| {
